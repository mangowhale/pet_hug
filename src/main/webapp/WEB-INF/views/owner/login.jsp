...
<body>
    ...
    <section>
        <div class="container" style="padding: 180px 0;">
            <div class="div-center" style="width: 30%; margin:0 auto;">
                <h2 class="mb-4">일반 로그인</h2>
                <form action="<c:url value="/owner/login_check"/>" class="form-horizontal">
                    <div>
                        <label for="" class="col-md-2">아이디</label> <input type="text" name="owner_id" class="input">
                    </div>
                    <div>
                        <label for="" class="col-md-2">비밀번호</label> <input type="password" name="owner_pw" class="input">
                    </div>
